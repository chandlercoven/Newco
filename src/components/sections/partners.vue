<template>
    <div class="w-full grid justify-items-center text-center text-custom-blue bg-custom-blue bg-opacity-5 py-24">
        ...
        <div class="grid gap-10 mt-16 justify-items-center h-fit px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16 font-bold opacity-30 text-4xl w-fit">
                ...
                <img src="../../assets/str8line-logo.jpg" class="w-[50%] md:w-[30%] my-auto mx-auto">
                ...
                <img src="../../assets/nubuildlogo.png" class="w-[30%] md:w-[20%] my-auto mx-auto">
                <img src="../../assets/rocketFloodLogo.jpg" class="w-[50%] md:w-[30%] my-auto mx-auto">
                <img src="../../assets/rocketMGAlogo.jpg" class="w-[50%] md:w-[30%] my-auto mx-auto">
        ...
        <img src="../../assets/dots.png" alt="Dots" class="z-0 left-2 absolute mt-[700px] lg:mt-[380px]">
    </div>
</template>
